...
def args_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="reduce the size of the dataset returned by get_dataset function ",
    )
    parser.add_argument(
        "--average_with_A", action="store_true", help="Exact Diffusion decentralized optimization algorithm"
    ) 
    parser.add_argument(
        "--phi_equal_w", action="store_true", help="Exact Diffusion decentralized optimization algorithm"
    ) 
    ########################## Decentralized Params ##########################
    parser.add_argument(
        "--exact_diffusion", action="store_true", help="Exact Diffusion decentralized optimization algorithm"
    ) 
    parser.add_argument(
        "--decentralized", action="store_true", help="Switch between a federated and fully-decentralized model"
    )
    parser.add_argument(
        "--edge_prob", type=float, default=1, help="number of rounds of training"
    )
    ...
    parser.add_argument(
        "--num_users", type=int, default=5, help="number of users: K")
    parser.add_argument(
